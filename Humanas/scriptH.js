...
// MODAL DA ATIVIDADE 01 (SEGUNDO TRIMESTRE) 
...
// MODAL DA ATIVIDADE 02 (SEGUNDO TRIMESTRE)
const modal3 = document.getElementById('modal3'); // chama pelo id a div do modal 
...
abrirModal3.addEventListener('click', () =>{ // adiciona um evento  ao clicar no botão
    modal3.style.display = 'flex'; // e nesse evento o modal abre o css que foi criado 
});
...
// MODAL DA ATIVIDADE 03 (SEGUNDO TRIMESTRE)
const modal4 = document.getElementById('modal4'); // chama pelo id a div do modal 
...
abrirModal4.addEventListener('click', () =>{ // adiciona um evento  ao clicar no botão
    modal4.style.display = 'flex'; // e nesse evento o modal abre o css que foi criado 
});
...
// MODAL DA ATIVIDADE 05 (TERCEIRO TRIMESTRE)
const modal6 = document.getElementById('modal6'); // chama pelo id a div do modal 
...
abrirModal6.addEventListener('click', () =>{ // adiciona um evento  ao clicar no botão
    modal6.style.display = 'flex'; // e nesse evento o modal abre o css que foi criado 
});
...
// MODAL DA ATIVIDADE 06 (TERCEIRO TRIMESTRE)
const modal7 = document.getElementById('modal7'); // chama pelo id a div do modal 
...
abrirModal7.addEventListener('click', () =>{ // adiciona um evento  ao clicar no botão
    modal7.style.display = 'flex'; // e nesse evento o modal abre o css que foi criado 
});
